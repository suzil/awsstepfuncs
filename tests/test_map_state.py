...
def test_map_state(state_input):
    ...
    assert stdout == [
        ...
        f'State output applying output path of "$": {expected_state_output[0]}',
        ...
        f'State output applying output path of "$": {expected_state_output[1]}',
        f"State output: {expected_state_output[1]}",
        "Terminating simulation of state machine",
        f'State output applying output path of "$": {expected_state_output}',
